...
%{__install} -D -m 755 plugins/cloud-aws/aws-java-sdk-1.2.15.jar -t %{buildroot}/%{base_install_dir}/plugins/cloud-aws
...
%{__install} -D -m 755 plugins/cloud-aws/jackson-core-asl-1.9.4.jar -t %{buildroot}/%{base_install_dir}/plugins/cloud-aws
